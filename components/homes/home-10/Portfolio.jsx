    ...
    <div className="container">
      <div className="row mb-90 mb-sm-50">
        <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
          ...
          <p className="mb-0">
            We blend innovation with expertise to deliver top-notch website
            development, mobile apps, SEO, revamps, management, and hosting.
            Elevate your digital presence with cutting-edge solutions designed
